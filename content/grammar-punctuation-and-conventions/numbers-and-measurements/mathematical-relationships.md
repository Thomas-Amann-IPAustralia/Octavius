...
### Use code, not punctuation, for mathematical symbols
...
The +, −, ×, and ÷ symbols are called ‘operators’ because they carry out an operation on 2 elements of a mathematical expression. The >, <, ≥ and ≤ symbols are ‘relations’ because they show a relationship between 2 elements of a mathematical expression.
...
Mathematical expressions in technical content often contain symbols and superscript. Superscript is a number, letter or symbol placed above a character, for example, the ‘2’ in ‘*x*2’.
...
To show subtraction, use [non-breaking spaces](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/mathematical-relationships#use_a_nonbreaking_space_to_keep_characters_and_symbols_together) around the minus symbol.
...
Use [non-breaking spaces](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/mathematical-relationships#use_a_nonbreaking_space_to_keep_characters_and_symbols_together) around the division symbol.
...
Use the mathematical symbol for the multiplication (×). Don’t use the letter ‘x’.
...
Use [non-breaking spaces](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/mathematical-relationships#use_a_nonbreaking_space_to_keep_characters_and_symbols_together) around the multiplication symbol.
...
When research shows that users need the symbols, use [non-breaking spaces](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/mathematical-relationships#use_a_nonbreaking_space_to_keep_characters_and_symbols_together) between the symbol and numbers.
...
When research shows that users need the symbols (and algebraic expressions), use [non-breaking spaces](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/mathematical-relationships#use_a_nonbreaking_space_to_keep_characters_and_symbols_together).
...
Put a [non-breaking space](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/mathematical-relationships#use_a_nonbreaking_space_to_keep_characters_and_symbols_together) around the equals symbol and around all operators except for the division slash – it is unspaced. If you think the equation is clearer with a space around the division slash, use a narrow no-break space (U+202F) or thin space (U+2009).
...
For general content, the Style Manual recommends using a displayed equation set as a block quotation. Code the block quotation with the HTML <blockquote> element.
...
Specialist mathematical publications often contain both inline and displayed equations. Follow the publisher’s style if you write specialist content.
