...
Many online reports put imprint page material on the splash screen or landing page. Wherever it features, people should be able to easily find copyright and other information about the report.
...
The National Library of Australia provides information about how to [apply for identifying numbers for your report](https://www.library.gov.au/services/publishers-and-self-publishers).
...
Your report may also be eligible for a cataloguing statement approved by the National Library’s [Prepublication Data Service](https://www.library.gov.au/services/publishers-and-self-publishers/prepublication-data-service).
...
Reports can have separate information related to the main text. Examples include case studies and lists of data.
