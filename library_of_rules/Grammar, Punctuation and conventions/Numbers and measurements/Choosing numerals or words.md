...
- [Use numerals for 2 and above in text](#use-numerals-for-2-and-above-in-text)  
- [Use words for 2 and above in these specific situations](#use-words-for-2-and-above-in-these-specific-situations)  
- [Write all numbers as numerals in these specific situations](#write-all-numbers-as-numerals-in-these-specific-situations)  
- [Use commas in numbers with 4 or more digits](#use-commas-in-numbers-with-4-or-more-digits)  
- [Combine numerals and words for large, rounded numbers](#combine-numerals-and-words-for-large-rounded-numbers)  
- [Use ‘1 million’ and ‘one million’ in certain contexts](#use-1-million-and-one-million-in-certain-contexts)  
- [Choose between numerals or words for currency](#choose-between-numerals-or-words-for-currency)  
...
If you have 2 series of numbers, for the sake of clarity you can use words for one series and numerals for the other.
...
> 2.5 × 10⁶ is the same as 2,500,000
...
Numbers below a million are easy to read as numerals. When you’re using rounded numbers of 1,000 or more, use commas to separate numerals into groups of 3 (working right to left). 

Use a combination of numerals and words for large numbers from a million when they are rounded. It is easier to read ‘2.5 million’ than ‘2,500,000’.
...
- quadrillion = 1,000 × trillion (10¹⁵)  
- quintillion = 1,000 × quadrillion (10¹⁸)
...
Our rule to combine numerals with words for large, rounded numbers includes ‘1 million’. The same rule applies to ‘1 billion’, ‘1 trillion’ and so on.

Use the numeral ‘1’ in large, rounded numbers for the reasons listed as exceptions in ‘Write all numbers as numerals in these specific situations’.
...
In general content, you can also use ‘1 million’ – the numeral and word together make the meaning clear.

The words ‘million’, ‘billion’ and ‘trillion’ appear immediately after the numeral ‘1’ in these large, rounded numbers. This proximity gives people the context they need. It’s unlikely users will mistake the numeral ‘1’ for the capital I or lower-case L – whatever font you use.
...
If you can’t, it is better to use words or follow each number with their equivalent word in parentheses:

- 1 (one) million  
- 7 (seven) million

And if you combine 1 and 7 in a number – for example, ‘1.7 million’ – follow the number with its equivalent in words in parentheses. This is awkward but avoids confusion.

**Example**

> An estimated 1 million of those eligible did not apply.  
> The report shows that telcos blocked over 1 (one) billion scams last year.  
> There are 1.7 million (one point seven million) Australians who are unaware they have the chronic disease.

Media releases follow journalistic style (one, two … nine, 10), but you can also choose to use numerals for large, rounded numbers.

**Example**

> After its recent expansion, which cost $5 million, the facility increased its production of sterile fruit flies to 40 million a week. In the 18 months since the facility opened, it has produced more than 1 billion flies for release.

### When to use ‘one million’

While our rule for large, rounded numbers captures ‘1 million’, our general rule for numbers is to use words for the numeral ‘one’. And in some content, writing ‘one million’ is a good choice.
...
> Every year, the facility recycles close to one billion plastic bottles.  
> One million dollars will allow the firm to expand production.  
> Nearly one million Australians downloaded the app last month.
