...
- [Check official place names and style them correctly](#check-official-place-names-and-style-them-correctly)  
- [Use capitals for names of places, roads and streets](#use-capitals-for-names-of-places-roads-and-streets)  
- [Use shortened forms for addresses](#use-shortened-forms-for-addresses)  
- [Write the names of buildings, structures and public places with an initial capital](#write-the-names-of-buildings-structures-and-public-places-with-an-initial-capital)  
- [Shorten names for states and territories in 4 situations](#shorten-names-for-states-and-territories-in-4-situations)  

---

## Check official place names and style them correctly

Using official Australian place names helps us all communicate more clearly. You can check the spelling of a place name using the [Australian Place Names dataset](https://data.gov.au/dataset/ds-dga-94f7b168-92a5-4d2a-9346-997bc4f708f7).
...
- It removes the requirement to use full stops with abbreviations of state names (as with other non-Latin abbreviations).  
