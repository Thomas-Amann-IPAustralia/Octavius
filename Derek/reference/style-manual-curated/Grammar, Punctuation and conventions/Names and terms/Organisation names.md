...
- [Write the name as the organisation writes it](#write-the-name-as-the-organisation-writes-it)
- [Check the correct name of an organisation](#check-the-correct-name-of-an-organisation)
- [Capitalise organisations’ names in 2 situations](#capitalise-organisations-names-in-2-situations)
- [Put a possessive apostrophe in a name if the organisation does](#put-a-possessive-apostrophe-in-a-name-if-the-organisation-does)
- [Use the singular verb with organisation names](#use-the-singular-verb-with-organisation-names)
...
> \[‘United Nations’ doesn't have an apostrophe because it is descriptive. Note the variant spelling of ‘Organization’.\]  
