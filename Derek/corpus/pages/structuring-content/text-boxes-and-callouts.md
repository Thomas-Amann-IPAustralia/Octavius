...
A one-by-one table is an option. If your document has complex formatting, [accessible PDF (Portable Document Format)](https://www.stylemanual.gov.au/format-writing-and-structure/content-formats/pdf-portable-document-format#make_pdf_content_accessible_to_all_users) may be a better option.
...
Casement D (30 January 2020) ‘MS Word accessibility: floating objects/text boxes’, MDBS Digiknow blog, accessed 30 July 2021.

GOV.UK (n.d.) ‘[Inset text](https://design-system.service.gov.uk/components/inset-text/)’, *Design system*, GOV.UK, accessed 20 May 2020.

New Zealand Government (2021) [ Accessibility for Microsoft Word documents](https://www.digital.govt.nz/standards-and-guidance/design-and-ux/accessibility/accessibility-for-microsoft-word-documents/), Digital.govt.nz, accessed 1 March 2021.

NSW Government (2022) ‘[Call-out box guidelines](https://education.nsw.gov.au/about-us/gel/building-your-web-pages/component-and-text-styles/call-out-box-guidelines)’, NSW Department of Education website, accessed 22 December 2022.

NSW Government (2022) ‘Word documents’, *Digital service toolkit*, Digital.NSW website, accessed 12 December 2022.

UC Santa Cruz (2018) ‘[HTML code to insert call-out boxes in your web page](https://wcmshelp.ucsc.edu/advanced/call-out.html)’, *Advanced WCMS topics*, UC Santa Cruz website, accessed 3 June 2020.
...
W3C (2020) [ Web Content Accessibility Guidelines (WCAG) overview](https://www.w3.org/WAI/standards-guidelines/wcag/), W3C website, accessed 29 May 2020.

W3C ARIA Authoring Practices Task Force (2016) [ ARIA landmarks example](https://www.w3.org/TR/wai-aria-practices/examples/landmarks/complementary.html), W3C website, accessed 29 May 2020.

WHATWG (Web Hypertext Application Technology Working Group) (2020) ‘[4.3.5: the aside element](https://html.spec.whatwg.org/multipage/sections.html#the-aside-element)’, *HTML: living standard*, WHATWG website, accessed 4 June 2020.



### Last updated

This page was updated Thursday 9 April 2026.