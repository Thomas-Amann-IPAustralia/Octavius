...
Separate the names of vehicles from titles in [citations and reference lists](https://www.stylemanual.gov.au/node/181). Separate them according to the type of publication:
...
Use the pronoun ‘it’ for ships, aircraft and other vehicles. Do not write ‘she’ when referring to vehicles in government content. Use pronouns that reflect [gender-neutral language](https://www.stylemanual.gov.au/node/64#use_genderneutral_language).
