...
The predicate can sometimes appear as a whole sentence because the subject is implied. This can depend on [the ‘mood’ of the verb](https://www.stylemanual.gov.au/node/128).
...
A noun phrase that is part of the subject is partially formed by [determiners (such as ‘the’)](https://www.stylemanual.gov.au/node/132).
...
A simple sentence contains only one [main (or principal) clause](https://www.stylemanual.gov.au/node/143). This means it has only one complete verb in it.
...
A complex sentence contains a main clause and at least one [subordinate clause](https://www.stylemanual.gov.au/node/143#subordinate_clauses_depend_on_the_main_clause).
...
- Wind forecasts are produced by computer models to show average speeds. [Passive voice with modified sentence structure: ‘by computer models’ is an [adverbial phrase](https://www.stylemanual.gov.au/node/144). It answers the question, ‘Who or what produces wind forecasts?’]
