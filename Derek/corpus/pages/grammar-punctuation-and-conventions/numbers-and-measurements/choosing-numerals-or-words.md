...
Use the numeral ‘1’ in large, rounded numbers for the reasons listed as exceptions in ‘[Write all numbers as numerals in these specific situations](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/choosing-numerals-or-words#write_all_numbers_as_numerals_in_these_specific_situations)’.
...
You can also use ‘1 million’ in general content – the numeral and word together make the meaning clear.

The words ‘million’, ‘billion’ and ‘trillion’ appear immediately after the numeral ‘1’ in these large, rounded numbers. This proximity gives people the context they need. It’s unlikely users will mistake the numeral ‘1’ for the capital i (I) or the lower-case L (l) – whatever font you use.
...
- There are 1.7 million (one point seven million) Australians who are unaware they have the chronic disease. [Number repeated in words to avoid possible confusion between 1 and 7 in some fonts]
