...
In Unicode, the en dash is U+2013. Use the entity &ndash; in HTML.

To make sure screen readers read the minus symbol, use the mathematical symbol for minus. In Unicode, this is U+2212. Use the entity &minus; in HTML.
...
Avoid using en dashes in most content.
...
- The help desk operates between 9 am – 4 pm daily.
...
Use en dashes for date spans in:
...
Date spans in headings should follow the general rule, except when:
...
Only use en dashes for time spans when you have limited space.

### Use an en dash for a financial year

For financial years, use 4 digits for the first number and only 2 digits for the second. Join them with an unspaced en dash.
...
### Use an en dash for a calendar year
...
### Use an en dash for a date span in titles of publications and programs
...
When you refer to a title published by another person or organisation, retain the style that was originally used for year spans.

#### Example

- *The diversity strategy 2020–25* [Publication with year span]
- *The Lake Eyre basin plan 1999–2004* [Publication with year span crossing a century]
- You can find more about milestones in our Wellbeing Action Plan 2005–2008. [Publication in organisation's house style]
- They found the statistics in *The year book of international trade 1922–23*. [Publication with original style for year span]
- ‘Headway’ is my favourite poem from the collection titled *Tryptych: selected poems 1956–1962*. [Publication with original style for year span]
- The *Milk for school children scheme 1951–74* provided free milk to Australian primary schools. [Program title]
- Our 2023–2024 Visa Nomination Program is now open. [Program title in organisation's house style]
- The author examines the short history of the *National energy program 1990–1991*. [Program title with original style for year span]

Reproduce titles with en dashes when you cite them as a reference.
...
### Use an en dash for a term of office
...
### Use an en dash for a date span when space is limited

Using en dashes for date spans is allowed when you have limited space. This could be in display text, tables, lists or in social media posts.
...
### Restrict the use of an en dash for a date span in headings
...
### Only use an en dash for a time span when space is limited

Use en dashes for time spans only when you have limited space. This could be in display text, tables, lists or in social media posts.
...
Thursday 18 April 11:15 am – midday
...
The en dash is unspaced when it connects only 2 numbers.

#### Example

- There were 25–30 head of cattle in quarantine in June and 50–60 in July. [Number span]
- Air quality declined during the 2003–2006 reporting period. [Year span]
...
Use an en dash between 2 nouns that both retain their original meaning. These are called ‘coordinate nouns’.

When describing something, coordinate nouns can function as [adjectives](https://www.stylemanual.gov.au/node/126).
...
## Rewrite to avoid joining a prefix with an en dash

A hyphen normally attaches a prefix to an adjectival phrase. In some cases, an en dash is correct, not a hyphen.
...
If you can, reword the phrase so that it doesn’t include the prefix.
...
Use them rarely to use them effectively – for example, to draw attention to a new and important detail for your main idea. As a rule, [don’t make your sentences complex or long](https://www.stylemanual.gov.au/node/204).
...
In Unicode, the em dash is U+2014. Use the entity &mdash; in HTML.
...
Ellipses cannot be used for this purpose, as they show the writer has deliberately left out quoted speech. Read related guidance on [ellipses](https://www.stylemanual.gov.au/node/115).
