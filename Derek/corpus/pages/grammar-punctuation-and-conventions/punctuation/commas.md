...
Choosing which style to use depends on the [context and the type of content](https://www.stylemanual.gov.au/grammar-punctuation-and-conventions/numbers-and-measurements/choosing-numerals-or-words#use_1_million_and_one_million_in_certain_contexts).
