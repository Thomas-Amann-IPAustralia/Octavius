...
Before starting a blog, do [user research](https://www.stylemanual.gov.au/node/76). Find out if people will use the blog and why.
...
Curious about what goes on at the museum? These blogs give you an inside peek.

[Blog posts focus on aspects of a service.]
...
- [headings](https://www.stylemanual.gov.au/node/51)
- [paragraphs](https://www.stylemanual.gov.au/node/53)
- [links](https://www.stylemanual.gov.au/node/193)
- [lists](https://www.stylemanual.gov.au/node/56)
- [search engine optimisation](https://www.stylemanual.gov.au/node/103).

Start with a title that helps users understand what the post is about. Include [keywords](https://www.stylemanual.gov.au/node/72). Avoid clickbait titles.
...
Include images in blog posts if they convey meaning or interest. Unless images are for decorative purposes, describe the visual information in [alt text](https://www.stylemanual.gov.au/node/49).
...
- Add [alt text for images](https://www.stylemanual.gov.au/node/49). For help with writing good alt text: the W3C [alt decision tree](https://www.w3.org/WAI/tutorials/images/decision-tree/).
...
Promote your blog post on [social media](https://www.stylemanual.gov.au/node/43). Tailor content to suit each platform.
