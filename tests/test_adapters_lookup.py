"""Adapter tests — lookup taxonomy (5 rules × test_fire + test_no_fire)."""
...
from logic.rulebook.adapters import compile_lookup


def _load_sample_rows(taxonomy: str = "lookup", n: int = 5) -> list[dict]:
